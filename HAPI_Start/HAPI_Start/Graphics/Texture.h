...
public:
	...
	void RenderSprite(HAPISPACE::BYTE* screen, int spriteSheetIndex, Vector2 spritePosition) const;
...
private:
	...
	void SpriteAlphaBlit(HAPISPACE::BYTE* screenStart, HAPISPACE::BYTE* spriteData, Vector2 position) const;
